 ...
 * @since 2.0.0
 */
public final class ArgusHttpTrace {
	 ...
	 * {@link ArgusHttpTraceRepository} implementations when recreating a trace from a
	 * persistent store.
	 ...
	 * @since 2.1.0
	 */
	public ArgusHttpTrace(Request request, Response response, Instant timestamp, Principal principal, Session session,
			Long timeTaken) {
	...
	ArgusHttpTrace(ArgusTraceableRequest request) {
	...
	public static final class Request {
		...
		private Request(ArgusTraceableRequest request) {
		 ...
		 * {@link ArgusHttpTraceRepository} implementations when recreating a request from a
		 * persistent store.
	...
	public static final class Response {
		...
		Response(ArgusTraceableResponse response) {
			this(response.getStatus(), response.getHeaders());
		}

		/**
		 * Creates a fully-configured {@code Response} instance. Primarily for use by
		 * {@link ArgusHttpTraceRepository} implementations when recreating a response from a
		 * persistent store.
