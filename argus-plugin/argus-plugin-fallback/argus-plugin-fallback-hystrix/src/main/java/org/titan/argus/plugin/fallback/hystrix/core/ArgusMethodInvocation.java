...
public class ArgusMethodInvocation implements ProxyMethodInvocation, Cloneable {
	...
	public MethodInvocation invocableClone(Object... arguments) {
		...
		try {
			ArgusMethodInvocation clone = (ArgusMethodInvocation) clone();
